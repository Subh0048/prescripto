  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-4 text-gray-900 md:mx-10 ">
        ...
        <p className="sm:w-1.5/3 text-sm text-center">simply browse through our extensive list of trusted doctors </p>
        ...
        <button className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-8">more</button>
      </div>
    </>
  );
};
